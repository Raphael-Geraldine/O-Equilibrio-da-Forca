...
> Todo o desenvolvimento do jogo, diagramas UML e código em C++/SFML/pthreads estão mantidos na **[branch master (código-fonte principal)](https://github.com/Raphael-Geraldine/O-Equilibrio-da-Forca/tree/master)**.
